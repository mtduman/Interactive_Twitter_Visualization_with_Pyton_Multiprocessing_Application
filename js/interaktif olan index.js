//function twWordCloud(twData) {
	...
	alert("dedde")
	d3.json("http://localhost:8025/tweet_word.txt",  function(error, data) {
...
//        if (error) { document.write('error', error); } 
//        else { document.write('success', data) }
//    });
...
//	twData.map(function(d) {
//        document.write(i ,"d.word");
//      });
...
//		  alert(twData);
		  ...
		  //		  alert("twData.length " +twData.woord)
